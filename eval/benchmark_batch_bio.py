...
results['Batch ASW'] = me.silhouette_batch(adata, batch_key=batch_key, group_key=label_key, embed=embed)
print("Batch ASW: " + str(results['Batch ASW']))
...
results['batch_score'] = np.nanmean([results['iLISI'], results['graph_conn'], results['kBET'],results['Batch ASW']])
