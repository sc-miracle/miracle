source("/opt/data/private/zjh/code/MIRACLE/utils/utils.R")
library(Seurat)
library(SeuratDisk)
library(Signac)
library(future)
...
# library(paletteer)
# col_20<-paletteer_d("ggthemes::Classic_20",n=20)
# col_10<-paletteer_d("ggthemes::Tableau_10")
# col_42 <- colorRampPalette(col_20)(42)
# mycol
...
col_10 <- c("#8FC36D", "#4472c4","#82B4ed", "#ff00ff",  "#f54646", "#D4aaff", "#008000", "#fff300")
